...
/*****************************************************************************
*  TWR-SER2 with TWR-MCF5441X uses the default port number 5.
******************************************************************************/
#define FNET_CFG_CPU_SERIAL_PORT_DEFAULT    (5)

#ifdef MCF5441X_NAND_FLASH
   #warning "The NAND Flash target does not work. It requires a bootloder to be added to the startup code. "
#endif
