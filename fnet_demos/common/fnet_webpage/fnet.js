		...
		<div id="fnet_menu_content">\
			<ul id="fnet_menu">\
				...
				<ul>\
					...
					<li><a href="/fnet_post.html">POST Demo</a></li>\
					<li><a href="/auth/fnet_auth.html">Authentication Demo<br/><font size="1">Username:<strong> fnet</strong><br/>Passward:<strong> freescale</strong></font></a></li>\
				</ul>\
				</li>\
			</ul>\
		</div>');
