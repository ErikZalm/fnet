...
CodeWarrior with the Freescale M5282EVB board.
...
- EXTERNAL_RAM:
This project target is setup to load and debug code from external RAM.
...
- EXTERNAL_FLASH:
This project target is setup to load and debug code in External FLASH.
This is the very basic project that outputs to the UART. User needs
to connect the terminal to see the output.
