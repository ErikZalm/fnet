...
#define MCF_GPIO_DDRTD                       (*(vuint8 *)(0x40100028))
#define MCF_GPIO_SETTD                       (*(vuint8 *)(0x40100040))
#define MCF_GPIO_CLRTD                       (*(vuint8 *)(0x40100058))
#define MCF_GPIO_PTDPAR                      (*(vuint8 *)(0x40100070))
...
#define MCF_GPIO_PORTLD                      (*(vuint8 *)(0x40100015))
#define MCF_GPIO_DDRLD                       (*(vuint8 *)(0x4010002D))
#define MCF_GPIO_SETLD                       (*(vuint8 *)(0x40100045))
#define MCF_GPIO_CLRLD                       (*(vuint8 *)(0x4010005D))
#define MCF_GPIO_PLDPAR                      (*(vuint8 *)(0x40100075))

#define MCF_GPIO_PORTGP                      (*(vuint8 *)(0x40100016))
#define MCF_GPIO_DDRGP                       (*(vuint8 *)(0x4010002E))
#define MCF_GPIO_SETGP                       (*(vuint8 *)(0x40100046))
#define MCF_GPIO_CLRGP                       (*(vuint8 *)(0x4010005E))
#define MCF_GPIO_PGPPAR                      (*(vuint8 *)(0x40100076))
