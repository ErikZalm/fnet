...
#define MCF_EPORT0_EPPAR                     (*(vuint16*)(0x40130000))
#define MCF_EPORT0_EPDDR                     (*(vuint8 *)(0x40130002))
#define MCF_EPORT0_EPIER                     (*(vuint8 *)(0x40130003))
#define MCF_EPORT0_EPDR                      (*(vuint8 *)(0x40130004))
#define MCF_EPORT0_EPPDR                     (*(vuint8 *)(0x40130005))
#define MCF_EPORT0_EPFR                      (*(vuint8 *)(0x40130006))

#define MCF_EPORT1_EPPAR                     (*(vuint16*)(0x40140000))
#define MCF_EPORT1_EPDDR                     (*(vuint8 *)(0x40140002))
#define MCF_EPORT1_EPIER                     (*(vuint8 *)(0x40140003))
#define MCF_EPORT1_EPDR                      (*(vuint8 *)(0x40140004))
#define MCF_EPORT1_EPPDR                     (*(vuint8 *)(0x40140005))
#define MCF_EPORT1_EPFR                      (*(vuint8 *)(0x40140006))

#define MCF_EPORT_EPPAR(x)                   (*(vuint16*)(0x40130000 + ((x)*0x10000)))
#define MCF_EPORT_EPDDR(x)                   (*(vuint8 *)(0x40130002 + ((x)*0x10000)))
#define MCF_EPORT_EPIER(x)                   (*(vuint8 *)(0x40130003 + ((x)*0x10000)))
#define MCF_EPORT_EPDR(x)                    (*(vuint8 *)(0x40130004 + ((x)*0x10000)))
#define MCF_EPORT_EPPDR(x)                   (*(vuint8 *)(0x40130005 + ((x)*0x10000)))
#define MCF_EPORT_EPFR(x)                    (*(vuint8 *)(0x40130006 + ((x)*0x10000)))
