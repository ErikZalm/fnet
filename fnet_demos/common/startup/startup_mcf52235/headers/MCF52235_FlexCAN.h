...
#define MCF_FlexCAN_CANMCR                   (*(vuint32*)(0x401C0000))
#define MCF_FlexCAN_CANCTRL                  (*(vuint32*)(0x401C0004))
#define MCF_FlexCAN_TIMER                    (*(vuint32*)(0x401C0008))
#define MCF_FlexCAN_RXGMASK                  (*(vuint32*)(0x401C0010))
#define MCF_FlexCAN_RX14MASK                 (*(vuint32*)(0x401C0014))
#define MCF_FlexCAN_RX15MASK                 (*(vuint32*)(0x401C0018))
#define MCF_FlexCAN_ERRCNT                   (*(vuint32*)(0x401C001C))
#define MCF_FlexCAN_ERRSTAT                  (*(vuint32*)(0x401C0020))
#define MCF_FlexCAN_IMASK                    (*(vuint32*)(0x401C0028))
#define MCF_FlexCAN_IFLAG                    (*(vuint32*)(0x401C0030))
