/*
 * File:		m52235evb_sysinit.h
 * Purpose:		Power-on Reset configuration of the M52235EVB.
 *
 * Notes:
 *
 */

#ifndef __M52235EVB_SYSINIT_H__
#define __M52235EVB_SYSINIT_H__
 ...
 */
#define SYSTEM_CLOCK_KHZ  60000    /* system bus frequency */
